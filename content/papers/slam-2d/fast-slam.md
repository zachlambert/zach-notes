...
Unlike [the gmapping approach](../grid-mapping-pf) which maintains a 2D occupancy map with each particle, this implementation is a 2D **landmark-based** SLAM algorithm.
